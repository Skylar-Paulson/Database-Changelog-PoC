...
- [Integration with Existing Systems](#integration-with-existing-systems)
  - [Existing Release Note Generation System](#existing-release-note-generation-system)
  - [How This Repository Integrates](#how-this-repository-integrates)
  - [Example: Unified Release Notes](#example-unified-release-notes)
  - [Benefits of Integration](#benefits-of-integration)
- [Comparison: Current vs Proposed Approach](#comparison-current-vs-proposed-approach)
...
- [Git Workflow](#git-workflow)
  ...
  - [What Gets Promoted](#what-gets-promoted)
  - [Preventing Duplicate Applications](#preventing-duplicate-applications)
  - [Tracking Applied Changes](#tracking-applied-changes)
...
- [Examples](#examples)
  - [Example 0: Release Artifact Structure](#example-0-release-artifact-structure)
  - [Example 1: Multi-Schema Release File Generation](#example-1-multi-schema-release-file-generation)
  - [Example 2: Manual Release for Hotfix](#example-2-manual-release-for-hotfix)
...
- [Proof-of-Concept Demonstration](#proof-of-concept-demonstration)
  ...
  - [Post-Demonstration Next Steps](#post-demonstration-next-steps)
  - [Resources for Demonstration](#resources-for-demonstration)
