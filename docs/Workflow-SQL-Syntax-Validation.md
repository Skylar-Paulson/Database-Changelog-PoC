...
- [When It Triggers](#when-it-triggers)
  - [Trigger 1: Pull Requests](#trigger-1-pull-requests)
  - [Trigger 2: Direct Pushes](#trigger-2-direct-pushes)
- [How It Works](#how-it-works)
  - [High-Level Process](#high-level-process)
  - [Detailed Steps](#detailed-steps)
- [Validation Rules](#validation-rules)
  - [✅ Valid SQL Examples](#-valid-sql-examples)
  - [❌ Invalid SQL Examples](#-invalid-sql-examples)
- [Required Status Check](#required-status-check)
- [Excluded Files](#excluded-files)
- [Edge Cases Handled](#edge-cases-handled)
  - [No SQL Files Changed](#no-sql-files-changed)
  - [Deleted SQL Files](#deleted-sql-files)
  - [MySQL Startup Failure](#mysql-startup-failure)
  - [Multiple Files, Some Fail](#multiple-files-some-fail)
- [Performance Characteristics](#performance-characteristics)
- [Configuration Options](#configuration-options)
  - [Change MySQL Version](#change-mysql-version)
  - [Change Trigger Branches](#change-trigger-branches)
  - [Add More Excluded Paths](#add-more-excluded-paths)
...
- [Troubleshooting](#troubleshooting)
  - [Validation Passes But SQL Fails in Database](#validation-passes-but-sql-fails-in-database)
  - [Validation Fails But SQL is Correct](#validation-fails-but-sql-is-correct)
  - [Validation Takes Too Long](#validation-takes-too-long)
...
- [Limitations](#limitations)
  - [What It Doesn't Validate](#what-it-doesnt-validate)
  - [For Comprehensive Validation](#for-comprehensive-validation)
- [Best Practices](#best-practices)
  - [Writing SQL for Validation](#writing-sql-for-validation)
  - [Example: Validation-Friendly SQL](#example-validation-friendly-sql)
